...
[x,fval, exitflag] = fmincon(C1,xi0,A,ones(num_timerange,1)*K,Aeq,[], lb, K*ones(size(xi0)), [], options);

%%
optimal_xi=x;
cost_SIR(optimal_xi, M, beta, gamma, N, Sinit, Iinit, Rinit, Vinit, tmax,m1,m2,k,costpervaccine,1);